...
abstract class REST_Controller extends CI_Controller {
    ...
    protected $http_status_codes = [
      ...
      /*  self::HTTP_OK_CODE => 'OK',
        self::HTTP_CREATED_CODE => 'CREATED',
        self::HTTP_NO_CONTENT_CODE => 'NO CONTENT',
        self::HTTP_NOT_MODIFIED_CODE => 'NOT MODIFIED',
        self::HTTP_BAD_REQUEST_CODE => 'BAD REQUEST',
        self::HTTP_UNAUTHORIZED_CODE => 'UNAUTHORIZED',
        self::HTTP_FORBIDDEN_CODE => 'FORBIDDEN',
        self::HTTP_NOT_FOUND_CODE => 'NOT FOUND',
        self::HTTP_METHOD_NOT_ALLOWED_CODE => 'METHOD NOT ALLOWED',
        self::HTTP_NOT_ACCEPTABLE_CODE => 'NOT ACCEPTABLE',
        self::HTTP_CONFLICT_CODE => 'CONFLICT',
        self::HTTP_INTERNAL_SERVER_ERROR_CODE => 'INTERNAL SERVER ERROR',
        self::HTTP_NOT_IMPLEMENTED_CODE => 'NOT IMPLEMENTED'*/
    ];
